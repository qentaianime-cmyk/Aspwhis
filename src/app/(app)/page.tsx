    ...
    <div ref={containerRef} className="w-full">
      ...
      <section className="relative min-h-[100svh] flex flex-col justify-end px-6 sm:px-12 pb-16 pt-28 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl w-full mx-auto">
          <div className="overflow-hidden mb-5">
            <p ref={taglineRef} className="text-xs font-mono tracking-[0.25em] text-primary uppercase opacity-0">
          ...
          <div className="overflow-hidden mb-8">
            <h1
              ref={titleRef}
              className="font-black tracking-tighter leading-[0.9] opacity-0"
          ...
          <div className="overflow-hidden mb-10 max-w-xl">
            <p ref={subtitleRef} className="text-base sm:text-xl text-muted-foreground leading-relaxed opacity-0">
      ...
      <section data-reveal className="relative py-28 sm:py-40 px-6 sm:px-12 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8">
          ...
          >
            {isAuthenticated ? "Your next room awaits." : "No email. No phone.\nJust start."}
          </h2>
          {!isAuthenticated ? (
